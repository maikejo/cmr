...
class RetiradasScreen extends StatefulWidget {

  @override
  _RetiradasScreenState createState() => _RetiradasScreenState();
}

class _RetiradasScreenState extends State<RetiradasScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.blueGrey[50],
        appBar: AppBar(
            title: Text("Solicitações de retirada"),
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ...
                              StreamBuilder<QuerySnapshot>(
                                  stream: Firestore.instance.collection("retirada").document(Auth.user.email).collection("lista").snapshots(),
