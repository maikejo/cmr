...
class FineyHeader extends StatelessWidget {
    ...
    return ResponsiveContainer(
      ...
      child: ResponsivePadding(
        ...
        child: Row(
          ...
          children: <Widget>[
            leftImageIconButton != null ? new InkWell(
            ...
            leftIconButton != null ? new InkWell(
              child: new ResponsivePadding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
            ...
            leftTextButton != null ? new InkWell(
              onTap: this.onPressLeftButton,
              child: new ResponsivePadding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
                child: Text(
                  leftTextButton,
                  style: CommonStyles(context: context).getHeaderTextButton()
                )
              )
            ) : Container(),
          ],
    ...
    return ResponsiveContainer(
      ...
      child: ResponsivePadding(
        ...
        child: Row(
          ...
          children: <Widget>[
            rightImageIconButton != null ? new InkWell(
            ...
            rightIconButton != null ? new InkWell(
              child: new ResponsivePadding(
                padding: const EdgeInsets.symmetric(horizontal: 8.0),
            ...
            rightTextButton != null ? new InkWell(
              onTap: this.onPressRightButton,
              child: new ResponsivePadding(
                padding: const EdgeInsets.only(right: 8.0, left: 8.0),
                child: Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(top: CommonVariables(context: context).getAppBarPaddingTop()),
      decoration: (noShadow == null || noShadow == false) ? new BoxDecoration(
        color: Colors.white,
        boxShadow: [
          const BoxShadow(
