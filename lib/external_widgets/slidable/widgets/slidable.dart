...
class SlidableState extends State<Slidable>
  ...
  Widget build(BuildContext context) {
    ...
    if (
      actionType == SlideActionType.primary && widget.actionDelegate != null && widget.actionDelegate.actionCount > 0 ||
        ...
        if (_resizeAnimation != null) {
          ...
          assert(() {
            if (_resizeAnimation.status != AnimationStatus.forward) {
              ...
              throw new FlutterError('widget from the application once that handler has fired.');
            }
            return true;
          }());
