...
abstract class ClosableSlideAction extends StatelessWidget {
  ...
  })  : assert(closeOnTap != null), super(key: key);
...
class SlideAction extends ClosableSlideAction {
  ...
  }) : assert(child != null), assert(decoration == null || decoration.debugAssertIsValid()), assert(color == null || decoration == null), decoration = decoration ?? (
...
class IconSlideAction extends ClosableSlideAction {
  ...
  const IconSlideAction({
    ...
    VoidCallback onTap,
    bool closeOnTap = _kCloseOnTap
  })  : color = color ?? Colors.white, super(key: key, onTap: onTap, closeOnTap: closeOnTap,);
