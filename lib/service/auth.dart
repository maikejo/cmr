...
class Auth {
 ...
 /* static Future<String> signInWithFacebok(String accessToken) async {
  ...
  static Future<String> getNome(String id) async {
    DocumentSnapshot snapshot= await Firestore.instance.collection('usuarios').document(id).get();
  ...
  static Future<Documentacao> getDocumentacao(String id) async {
    DocumentSnapshot snapshot= await Firestore.instance.collection('documentacao').document(id).get();
   ...
   var _urlDocResidencia = snapshot['urlDocResidencia'];
    ...
    Documentacao documentacao = new Documentacao(urlDocIdentificacao: _urlDocIdentificacao,urlDocResidencia: _urlDocSelf,urlDocSelf: _urlDocResidencia);
